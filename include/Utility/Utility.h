...
public:
	...
	void Init(const bool& toggleIn, const Rectangle& recIn, const std::string& textIn);
	void Init(const bool& toggleIn, const Rectangle& recIn, const std::string& textIn, const Color& textColorIn, const Color& bodyColorIn, const Color& toggleBodyColorIn, const Color& edgeColorIn);
	void Init(const bool& toggleIn, const Rectangle& recIn, const Texture2D& textureIn);
...
public:
	...
	void Init(const std::string& text, const Vector2& pos);
	void Init(const std::string& text, const Vector2& pos, const int& textSizeIn, const Color& textColorIn);
