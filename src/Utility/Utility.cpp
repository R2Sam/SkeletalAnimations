...
void Button::Init(const bool& toggleIn, const Rectangle& recIn, const std::string& textIn)
{
    _toggle = toggleIn;
    _rectangle = recIn;
    _text = textIn;
...
void Button::Init(const bool& toggleIn, const Rectangle& recIn, const std::string& textIn, const Color& textColorIn, const Color& bodyColorIn, const Color& toggleBodyColorIn, const Color& edgeColorIn)
{
    _toggle = toggleIn;
    _rectangle = recIn;
    _text = textIn;
    _textColor = textColorIn;
    _bodyColor = bodyColorIn;
    _toggleBodyColor = toggleBodyColorIn;
    _edgeColor = edgeColorIn;

    _textMode = true;
}

void Button::Init(const bool& toggleIn, const Rectangle& recIn, const Texture2D& textureIn)
{
    _toggle = toggleIn;
    _rectangle = recIn;
    _texture = textureIn;
...
void Text::Init(const std::string& text, const Vector2& pos)
{
	_text = text;
	_pos = pos;
}

void Text::Init(const std::string& text, const Vector2& pos, const int& textSizeIn, const Color& textColorIn)
{
	_text = text;
	_pos = pos;

	_textSize = textSizeIn;
	_textColor = textColorIn;
}
